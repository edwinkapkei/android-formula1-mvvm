...
class F1RemoteDataSourceImpl(
    ...
    override suspend fun getCurrentSchedule(year: String): ScheduleResponse {
        return f1APIService.getCurrentSchedule(year)
    }

    override suspend fun getCurrentDrivers(year: String): DriversResponse {
        return f1APIService.getCurrentDrivers(year)
    }

    override suspend fun getCurrentConstructors(year: String): ConstructorsResponse {
